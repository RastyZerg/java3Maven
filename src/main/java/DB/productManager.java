...
public class productManager {
    ...
    //    вывести сообщение "Такого товара нет" если товара не в базе. Консольная команда: "/цена
    //    товар545"
    //             Добавить возможность изменения цены товара (указываем имя товара и новую цену).
    //    Консольная команда: "/сменитьцену товар10 10000"
    //             Вывести товары в заданном ценовом диапазоне. Консольная команда: "/товарыпоцене
    //            100 600"
